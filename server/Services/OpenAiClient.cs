...
public sealed class OpenAiClient(HttpClient http, ILogger<OpenAiClient> log)
{
    public const string DefaultSystemPrompt = """
        ...
        Do NOT flag: anything that could plausibly come from the author or their official publisher. This includes — but is not limited to — chapter headings, tables of contents, "also by this author" pages, author's notes / prefaces / afterwords, "Book 2 is out now" or other author self-promotion, links to the author's official store / Amazon / Patreon / RoyalRoad, dedications, epigraphs, copyright and ISBN pages, glossaries, character lists, maps, content warnings, translator/editor notes, or any text that could reasonably be part of the story or its legitimate front/back matter. Official content stays, even when it's not story prose.
