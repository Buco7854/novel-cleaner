...
public sealed record CleanResult(bool HasWatermarks, IReadOnlyList<RemovalInstruction> Items);
...
public sealed class OpenAiClient(HttpClient http, ILogger<OpenAiClient> log)
{
    public const string DefaultSystemPrompt = """
        ...
        Rules:
        - Copy the text to remove VERBATIM — do not paraphrase, summarise, or truncate.
    ...
    private static CleanResult Parse(string raw)
    {
        ...
        return new CleanResult(items.Length > 0, items);
    }
