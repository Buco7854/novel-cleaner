  ...
  return (
    <Routes>
      ...
      <Route element={<ProtectedRoute><AppLayout /></ProtectedRoute>}>
        ...
        {/* Opening a book in the library lands directly in the editor —
            it folds in the old detail surface (status, logs, action
            buttons). */}
        <Route path="/books/:id" element={<EditorPage />} />
        ...
        <Route path="/admin/usage" element={<ProtectedRoute requireAdmin><AdminUsagePage /></ProtectedRoute>} />
      </Route>
