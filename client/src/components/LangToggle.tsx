  ...
  return (
    <Listbox value={current} onChange={(lng) => i18n.changeLanguage(lng)}>
      <div className="relative">
        ...
        >
          <ListboxOptions className="absolute right-0 z-50 mt-1 w-36 origin-top-right rounded-lg border border-stone-200 bg-white p-1 shadow-sm dark:border-stone-700 dark:bg-stone-800">
            {LANGS.map((l) => (
              <ListboxOption
                key={l.value}
                value={l.value}
