...
export function AppLayout() {
  ...
  return (
    <div className="flex min-h-full flex-col">
      <header className="sticky top-0 z-30 border-b border-stone-200/80 bg-white/95 backdrop-blur dark:border-stone-800 dark:bg-stone-950/90">
          ...
          <div className="ml-auto hidden items-center gap-1.5 md:flex">
            ...
            <Menu as="div" className="relative">
              ...
              <Transition as={Fragment}
                ...
                <MenuItems className="absolute right-0 z-50 mt-1.5 w-60 origin-top-right rounded-xl bg-white p-1.5 shadow-lg ring-1 ring-stone-200 dark:bg-stone-900 dark:ring-stone-700">
                  <div className="border-b border-stone-200 px-2 py-2 dark:border-stone-700">
                  ...
                  {isAdmin && (
                    <div className="px-2 py-1.5">
                      <span className="pill bg-stone-100 text-stone-700 ring-stone-200 dark:bg-stone-800 dark:text-stone-300 dark:ring-stone-700">
                        <Shield className="h-3 w-3" /> {t("app.admin")}
                      </span>
                    </div>
                  )}
                  <MenuItem>
      ...
      <Transition show={mobileOpen} as={Fragment}>
        <div className="fixed inset-0 z-40 md:hidden">
          ...
          <TransitionChild as={Fragment}
            ...
            <aside className="absolute left-0 top-0 flex h-full w-72 flex-col bg-white shadow-xl dark:bg-stone-950">
    ...
    <Listbox value={currentLang} onChange={(lng) => i18n.changeLanguage(lng)}>
      <div className="relative">
        ...
        <Transition as={Fragment}
          enter="transition ease-out duration-100" enterFrom="opacity-0 scale-95" enterTo="opacity-100 scale-100"
          leave="transition ease-in duration-75" leaveFrom="opacity-100 scale-100" leaveTo="opacity-0 scale-95">
          <ListboxOptions className="absolute right-0 z-50 mt-1.5 w-40 origin-top-right rounded-xl bg-white p-1.5 shadow-lg ring-1 ring-stone-200 dark:bg-stone-900 dark:ring-stone-700">
            {LANGS.map((l) => (
              <ListboxOption
                key={l.value}
                value={l.value}
